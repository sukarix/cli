...
enable_tests() {
  ...
  cp -Rv "$BASEDIR/../tools/statera.php" "$BASEDIR/../public/statera/index.php"
  cp -Rv "$BASEDIR/../tests/ui/css" "$BASEDIR/../public/statera/"
  cp -Rv "$BASEDIR/../tests/ui/images" "$BASEDIR/../public/statera/"
  cp -Rv "$BASEDIR/../tests/ui/css" "$BASEDIR/../public/statera/result"
  cp -Rv "$BASEDIR/../tests/ui/images" "$BASEDIR/../public/statera/result"
